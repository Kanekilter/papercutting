(function($) {
    $.fn.jquizzy = function(settings) {
        ...
        superContainer.find('.final').click(function() {
            ...
            resultSet = '<br/>鼠标指向题目序号可查看题目<br/>蓝色为已选错误选项<br/>红色为题目正确选项<br/> '+'<h2 class="qTitle">' + judgeSkills(score) + '<br/>您的分数： ' + score + '</h2>' + shareButton + '<div class="jquizzy-clear"></div>' + resultSet + '<div class="jquizzy-clear"></div>';
